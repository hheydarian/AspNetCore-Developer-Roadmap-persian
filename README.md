...
![.NET](https://img.shields.io/badge/.NET-8.0-blueviolet?logo=dotnet&style=flat)
![ASP.NET Core](https://img.shields.io/badge/ASP.NET-Core-blue?logo=dotnet&style=flat)
![Roadmap](https://img.shields.io/badge/Learning-Roadmap-orange?logo=github&style=flat)
[![GitHub stars](https://img.shields.io/github/stars/hheydarian/AspNetCore-Developer-Roadmap-persian?style=social)](https://github.com/hheydarian/AspNetCore-Developer-Roadmap-persian/stargazers)
...
> **«نقشه راه برای تبدیل شدن به یک توسعه‌دهنده [ASP.NET Core](https://docs.microsoft.com/aspnet/core) در سال ۲۰۲۵»**


**«در نمودار زیر می‌توانید مسیرهایی که می‌توانید طی کنید و کتابخانه‌هایی که بهتر است برای تبدیل شدن به یک توسعه‌دهنده ASP.NET Core یاد بگیرید را مشاهده کنید.
این نمودار را به‌عنوان راهنمایی برای همه کسانی آماده کرده‌ام که از من می‌پرسند: "به‌عنوان یک توسعه‌دهنده ASP.NET Core، قدم بعدی من برای یادگیری چه چیزی باید باشد؟"»**

---
## ⚠️ سلب مسئولیت

> هدف از این نقشه راه اینه که بهت دیدی کلی از مسیر یادگیری بده. این نقشه راه بیشتر برای وقتیه که نمی‌دونی قدم بعدی چی باید یاد بگیری، نه اینکه صرفاً دنباله‌رو چیزهای مد روز و ترندی باشی.
بهتره درک کنی چرا یک ابزار در یک موقعیت خاص بهتر از بقیه عمل می‌کنه و همیشه یادت باشه: «مد روز بودن» لزوماً به معنی «بهترین بودن برای کار» نیست.

---

## ⭐ ستاره بده!

اگه این پروژه رو دوست داشتی یا داری ازش برای یادگیری و شروع راه‌حل‌هات استفاده می‌کنی، خوشحال می‌شم بهش یه ستاره بدی. ممنون! 🙏

---

## نقشه راه

![Roadmap](https://github.com/hheydarian/AspNetCore-Developer-Roadmap/blob/master/aspnetcore-developer-roadmap.png)
## منابع
...
اگر فکر می‌کنی این نقشه راه می‌تونه بهتر بشه، لطفاً هر گونه به‌روزرسانی را از طریق PR ارسال کن و مشکلات رو هم گزارش بده.
همچنین من این نقشه راه رو به‌طور مداوم بهبود می‌دم، پس ممکنه بخوای به این مخزن ستاره بدی تا دوباره راحت پیداش کنی.

---

### مخزن اصلی : 
[ASP.NET Core](https://github.com/MoienTajik/AspNetCore-Developer-Roadmap)
